    ...
    return (
        <>
            <div className="left-fields">
                <img className="icons-nav" src="/public/conversacion.png" alt="mensaje" />
                <img className="icons-nav" src="/public/notificacion.png" alt="mensaje" />
                <div>
                    <div className="profile">
                        ...
                        <img className="icons" src="public\flecha-hacia-abajo-para-navegar.png" alt="opciones" />
                    </div>
                    <IconBox />
                </div>
            </div>
